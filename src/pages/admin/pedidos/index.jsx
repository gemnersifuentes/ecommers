        ...
        <div className="min-h-screen pb-20">
                ...
                <div className="flex flex-col gap-6 items-start">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap items-center gap-4 flex-1">
                            ...
                            <div className="flex bg-white dark:bg-[#111c44] p-1 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`relative flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all duration-300 whitespace-nowrap ${filtroEnvio === tab.id ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300'
                                            }`}
                                    >
                                        {filtroEnvio === tab.id && (
                                            <motion.div
                            ...
                            <div className="relative group min-w-[180px]">
                                ...
                                <select
                                    className="w-full pl-9 pr-8 py-2.5 bg-white dark:bg-[#111c44] border border-gray-200 dark:border-white/5 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 dark:focus:border-orange-500/30 transition-all text-[10px] font-black text-[#1e293b] dark:text-gray-400 appearance-none cursor-pointer shadow-sm uppercase tracking-wider"
                                    value={filtroEstado}
                        ...
                        <div className="flex items-center gap-3 bg-gray-50/50 dark:bg-white/5 px-3 py-1.5 rounded-2xl border border-dashed border-gray-200 dark:border-white/10 ml-auto">
                            <span className="text-[9px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest hidden sm:inline">Mostrar:</span>
                            <div className="relative group min-w-[110px]">
                                ...
                                <select
                                    className="w-full pl-9 pr-8 py-2 bg-white dark:bg-[#111c44] border border-gray-200 dark:border-white/5 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all text-[10px] font-black text-[#1e293b] dark:text-gray-400 appearance-none cursor-pointer shadow-sm uppercase tracking-wider"
                                    value={itemsPerPage}
                                    onChange={(e) => {
                    ...
                    <table className="w-full text-left border-separate border-spacing-0">
                        <thead className="bg-[#f8fafc]/80 dark:bg-white/5 backdrop-blur-md sticky top-0 z-20 border-b border-gray-100 dark:border-white/5">
                            <tr>
                                ...
                                <th className="px-4 py-4 text-[10px] font-black text-[#64748b] dark:text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-white/5 whitespace-nowrap">CLIENTE</th>
                                <th className="px-4 py-4 text-[10px] font-black text-[#64748b] dark:text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-white/5 whitespace-nowrap text-center">ENVÍO</th>
                                <th className="px-4 py-4 text-[10px] font-black text-[#64748b] dark:text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-white/5 whitespace-nowrap text-center">FECHA</th>
                                <th className="px-4 py-4 text-[10px] font-black text-orange-600 uppercase tracking-wider border-b border-gray-100 dark:border-white/5 text-center whitespace-nowrap">TOTAL</th>
                                            ...
                                            >
                                                <td className="px-4 py-3 relative">
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-9 h-9 rounded-lg bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 flex items-center justify-center text-[#1e293b] dark:text-white group-hover:border-orange-200 dark:group-hover:border-orange-500/30 transition-all duration-300 shadow-sm">
                                                            <ShoppingBag size={14} strokeWidth={2.5} />
                                                        </div>
                                                        <span className="text-[11px] font-black text-[#1e293b] dark:text-white tabular-nums font-mono tracking-wider">
                                                ...
                                                <td className="px-4 py-3">
                                                    <div className="flex flex-col">
                                                        <div className="flex items-center gap-1.5 text-[11px] font-black text-[#1e293b] dark:text-white uppercase tracking-tight truncate max-w-[140px]">
                                                            {pedido.cliente_nombre}
                                                        </div>
                                                        <div className="flex items-center gap-1.5 text-[9px] font-bold text-gray-400 dark:text-gray-500 mt-0.5 lowercase truncate max-w-[140px]">
                                                            {pedido.correo}
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td className="px-4 py-3 text-center">
                                                    <div className="inline-flex flex-col items-center gap-0.5 px-2 py-1 rounded-lg border border-gray-100 dark:border-white/10 bg-gray-50/50 dark:bg-white/5 group-hover:bg-white dark:group-hover:bg-white/10 transition-colors">
                                                        <EnvioIcon size={12} className="text-[#64748b] dark:text-gray-400" />
                                                        <span className="text-[8px] font-black text-[#64748b] dark:text-gray-400 tracking-tighter">{envio.label}</span>
                                                    </div>
                                                </td>

                                                <td className="px-4 py-3 text-center">
                                                    <div className="inline-flex items-center gap-1 px-2 py-0.5 bg-gray-50 dark:bg-white/5 text-gray-500 dark:text-gray-400 rounded-md font-bold text-[9px] border border-gray-200/50 dark:border-white/5">
                                                ...
                                                <td className="px-4 py-3 text-center">
                                                    <div className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-sm font-black text-[9px] tracking-wider border transition-all whitespace-nowrap ${config.color} dark:bg-opacity-10 dark:border-opacity-20`}>
                                                ...
                                                <td className="px-4 py-3">
                                                    <div className="flex items-center justify-end gap-1">
                                                        {[
                                                            { to: `/admin/pedidos/ver/${pedido.id}`, icon: Eye, label: 'Ver Detalles', color: 'hover:text-orange-600 dark:hover:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-500/5' },
                                                            { to: `/admin/pedidos/editar/${pedido.id}`, icon: Edit, label: 'Gestionar Estado', color: 'hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-500/5' }
                                                        ].map((action, i) => (
                                                            <Link
                                                                key={i}
                                                                to={action.to}
            ...
            {totalPages > 1 && (
                <div className="flex items-center justify-between mt-6 px-2">
                    <p className="text-[10px] text-gray-400 dark:text-gray-500 font-black uppercase tracking-widest">
                        Resumen: <span className="text-gray-900 dark:text-gray-300">{currentPage}</span> / <span className="text-gray-400 dark:text-gray-600">{totalPages}</span>
                    </p>
                    <div className="flex items-center gap-1.5">
                        <button
                            onClick={() => setCurrentPage(1)}
                            disabled={currentPage === 1}
                            className="p-2 bg-white dark:bg-[#111c44] border border-gray-200 dark:border-white/5 rounded-xl disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer text-gray-500 dark:text-gray-400 hover:border-orange-200 dark:hover:border-white/20 hover:text-orange-500 transition-all shadow-sm"
                        >
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-8 h-8 rounded-xl text-[10px] font-black transition-all cursor-pointer ${currentPage === n
                                                ...
                                                : 'bg-white dark:bg-[#111c44] text-gray-400 dark:text-gray-500 border border-gray-100 dark:border-white/5 hover:border-gray-200 dark:hover:border-white/10'
                                                }`}
                                        >
                                            {n}
                                        </button>
            ...
            {!loading && filteredPedidos.length > 0 && (
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="mt-8 flex items-center justify-between text-[9px] font-black text-gray-300 dark:text-gray-600 uppercase tracking-[0.2em] px-2"
                >
